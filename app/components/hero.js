      ...
      <div className="max-w-6xl mx-auto px-8">
        <div className="flex flex-col items-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-4 mt-16 text-center leading-tight">
            Empower Your <span className="bg-lime-100 text-lime-900 py-1 px-2 rounded inline-block">Assets</span>: Borrow and Lend with Confidence.
          </h1>
          <p className="text-lg md:text-xl text-gray-600 text-center px-16 mb-10 mt-6">
